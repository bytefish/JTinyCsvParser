...
A simple String split with a comma as column delimiter will lead to wrong data, so the line 
...
I strongly suggest using the :java:`RFC4180Tokenizer` for quoted data.
...
highly recommend to use the :java:`RFC4180Tokenizer` for working with complex CSV data. 
